...
This module provides Gunicorn configuration with Uvicorn workers
for high-performance FastAPI applications.

Classes:
    * UvicornWorker - Custom Uvicorn worker configuration
    * GunicornApplication - Gunicorn application wrapper
    ...
    def __init__(  # (Too many args)
        ...
        **kwargs: Any,
        ...
        self.options = {
            ...
            "workers": workers,
            "timeout": 120,
            "worker_class": "infra.server.gunicorn.UvicornWorker",
            **kwargs,
        }
        self.app = app
        super().__init__()
